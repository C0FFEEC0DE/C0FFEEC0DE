...
basics:
  ...
  email: "TODO@example.com"               # TODO: реальный email
...
Быстрее всего по почте: TODO@example.com — обычно отвечаю в течение дня. Открыт к старшим DevOps / SRE и cloud-infrastructure ролям в удалённо-дружественных командах (Белград, Сербия — ПМЖ, часовой пояс CET, без визовой поддержки).