# C0FFEEC0DE — résumé, for humans and AI agents
...
- **Machine-readable** for robots: [JSON Resume](https://jsonresume.org) `resume.json`, an `llms.txt` index, an `AGENTS.md`, and a flat `resume.txt`.
...
Repo-level guidance for AI agents working here is in [`AGENTS.md`](AGENTS.md).
